...
M.cfg = {"wwwroot":"https:\/\/moodle.nottingham.ac.uk","sesskey":"kaFBEDnIK7","sessiontimeout":"7200","sessiontimeoutwarning":1200,"themerev":"1663777335","slasharguments":1,"theme":"nottingham_mhs","iconsystemmodule":"core\/icon_system_fontawesome","jsrev":"1663777335","admin":"admin","svgicons":true,"usertimezone":"Europe\/London","contextid":8872110,"langrev":1663777335,"templaterev":"1663777335"};var yui1ConfigFn = function(me) {if(/-skin|reset|fonts|grids|base/.test(me.name)){me.type='css';me.path=me.path.replace(/\.js/,'.css');me.path=me.path.replace(/\/yui2-skin/,'/assets/skins/sam/yui2-skin')}};
...
<table width="100%" border="0" cellspacing="0" cellpadding="3" height="250">
  <tr>
    ...
    id="nav-notification-popover-container" data-userid="308477"
    data-region="popover-region">
    <div class="popover-region-toggle nav-link icon-no-margin"
        data-region="popover-region-toggle"
        role="button"
        aria-controls="popover-region-container-637b8c9535466637b8c952b4ca2"
        aria-haspopup="true"
    ...
    <div 
        id="popover-region-container-637b8c9535466637b8c952b4ca2"
    ...
    <a id="message-drawer-toggle-637b8c953d13f637b8c952b4ca3" class="nav-link d-inline-block popover-region-toggle position-relative icon-no-margin" href="#"
            role="button">
                ...
                <div class="action-menu-trigger">
                    <div class="dropdown">
                        <a href="#" tabindex="0" class="d-inline-block  dropdown-toggle icon-no-margin" id="action-menu-toggle-1" aria-label="User menu" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" aria-controls="action-menu-1-menu">
                            ...
                            <span class="userbutton"><span class="usertext mr-1">Azoof Qalyoubi</span><span class="avatars"><span class="avatar current"><img src="https://moodle.nottingham.ac.uk/theme/image.php/nottingham_mhs/core/1663777335/u/f2" class="userpicture defaultuserpic" width="35" height="35" alt="" /></span></span></span>
                    ...
                    <div class="dropdown-divider" role="presentation"><span class="filler">&nbsp;</span></div>
                                                                <a href="https://moodle.nottingham.ac.uk/user/profile.php?id=308477" class="dropdown-item menu-action" role="menuitem" data-title="profile,moodle" tabindex="-1" aria-labelledby="actionmenuaction-2">
                    ...
                    <div class="dropdown-divider" role="presentation"><span class="filler">&nbsp;</span></div>
                                                                <a href="https://moodle.nottingham.ac.uk/login/logout.php?sesskey=kaFBEDnIK7" class="dropdown-item menu-action" role="menuitem" data-title="logout,moodle" tabindex="-1" aria-labelledby="actionmenuaction-6">
...
<div class="row">
    ...
    <div class="col-md-4">        <div class="mdl-align">
            <div class="urlselect">
    <form method="post" action="https://moodle.nottingham.ac.uk/course/jumpto.php" class="form-inline" id="url_select_f637b8c952b4ca12">
        <input type="hidden" name="sesskey" value="kaFBEDnIK7">
...
coursework) per module.<br></p></div>
  ...
  <span id="sb-4"></span></aside>
    ...
    <div
    id="drawer-637b8c95431d3637b8c952b4ca13"
    ...
    tabindex="0"
>
            <div id="message-drawer-637b8c95431d3637b8c952b4ca13" class="message-app" data-region="message-drawer" role="region">
            ...
            <div class="body-container position-relative" data-region="body-container">
                ...
                >
                ...
                </div>                <div class="hidden h-100" data-region="view-contacts" aria-hidden="true" data-user-id="308477">
                    <div class="d-flex flex-column h-100">
                        <div class="p-3 border-bottom">
                            <ul class="nav nav-pills nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a
                                        id="contacts-tab-637b8c95431d3637b8c952b4ca13"
                                        class="nav-link active"
                                        href="#contacts-tab-panel-637b8c95431d3637b8c952b4ca13"
                                        data-toggle="tab"
                                        data-action="show-contacts-section"
                                        role="tab"
                                        aria-controls="contacts-tab-panel-637b8c95431d3637b8c952b4ca13"
                                        aria-selected="true"
                                    >
                                        Contacts
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a
                                        id="requests-tab-637b8c95431d3637b8c952b4ca13"
                                        class="nav-link"
                                        href="#requests-tab-panel-637b8c95431d3637b8c952b4ca13"
                                        data-toggle="tab"
                                        data-action="show-requests-section"
                                        role="tab"
                                        aria-controls="requests-tab-panel-637b8c95431d3637b8c952b4ca13"
                                        aria-selected="false"
                                    >
                                        Requests
                                        <span class="badge badge-primary bg-primary ml-2 hidden"
                    ...
                    data-user-id="308477"
                                        id="contacts-tab-panel-637b8c95431d3637b8c952b4ca13"
                    data-section="contacts"
                    role="tabpanel"
                    aria-labelledby="contacts-tab-637b8c95431d3637b8c952b4ca13"
                ...
                >
                    ...
                    data-region="lazy-load-list"
                    data-user-id="308477"
                                        id="requests-tab-panel-637b8c95431d3637b8c952b4ca13"
                    data-section="requests"
                    role="tabpanel"
                    aria-labelledby="requests-tab-637b8c95431d3637b8c952b4ca13"
                ...
                >
                    <div
                        ...
                        style="overflow-y: auto"
                    ></div>
                </div>                <div class="h-100 view-overview-body" aria-hidden="false" data-region="view-overview"  data-user-id="308477">
                    <div id="message-drawer-view-overview-container-637b8c95431d3637b8c952b4ca13" class="d-flex flex-column h-100" style="overflow-y: auto">
                            ...
                            >
                                <div id="view-overview-favourites-toggle" class="card-header" data-region="toggle">
                                    <button
                                        ...
                                        data-target="#view-overview-favourites-target-637b8c95431d3637b8c952b4ca13"
                                        aria-expanded="false"
                                        aria-controls="view-overview-favourites-target-637b8c95431d3637b8c952b4ca13"
                                    >
                                ...
                                data-region="lazy-load-list"
                                data-user-id="308477"
                                            id="view-overview-favourites-target-637b8c95431d3637b8c952b4ca13"
            aria-labelledby="view-overview-favourites-toggle"
            data-parent="#message-drawer-view-overview-container-637b8c95431d3637b8c952b4ca13"
                            ...
                            >
                                <div id="view-overview-group-messages-toggle" class="card-header" data-region="toggle">
                                    <button
                                        class="btn btn-link w-100 text-left p-1 p-sm-2 d-flex align-items-center overview-section-toggle collapsed"
                                        data-toggle="collapse"
                                        data-target="#view-overview-group-messages-target-637b8c95431d3637b8c952b4ca13"
                                        aria-expanded="false"
                                        aria-controls="view-overview-group-messages-target-637b8c95431d3637b8c952b4ca13"
                                    >
                                        <span class="collapsed-icon-container">
                                            <i class="icon fa fa-caret-right fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                ...
                                data-region="lazy-load-list"
                                data-user-id="308477"
                                            id="view-overview-group-messages-target-637b8c95431d3637b8c952b4ca13"
                            ...
                            >
                                <div id="view-overview-messages-toggle" class="card-header" data-region="toggle">
                                    <button
                                        class="btn btn-link w-100 text-left p-1 p-sm-2 d-flex align-items-center overview-section-toggle collapsed"
                                        data-toggle="collapse"
                                        data-target="#view-overview-messages-target-637b8c95431d3637b8c952b4ca13"
                                        aria-expanded="false"
                                        aria-controls="view-overview-messages-target-637b8c95431d3637b8c952b4ca13"
                                    >
                                        <span class="collapsed-icon-container">
                                            <i class="icon fa fa-caret-right fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                ...
                                data-region="lazy-load-list"
                                data-user-id="308477"
                                            id="view-overview-messages-target-637b8c95431d3637b8c952b4ca13"
                        ...
                        <div data-region="settings" class="p-3">
                                    ...
                                    <legend class="sr-only">Accept messages from:</legend>
                                        <div class="custom-control custom-radio mb-2">
                                            <input
                                                ...
                                                id="block-noncontacts-637b8c95431d3637b8c952b4ca13-1"
                                                value="1"
                                            >
                                            <label class="custom-control-label ml-2" for="block-noncontacts-637b8c95431d3637b8c952b4ca13-1">
                                                My contacts only
                                            </label>
                                        </div>
                                        <div class="custom-control custom-radio mb-2">
                                            <input
                                                ...
                                                name="message_blocknoncontacts"
                                                class="custom-control-input"
                                                id="block-noncontacts-637b8c95431d3637b8c952b4ca13-0"
                                                value="0"
                                            >
                                            <label class="custom-control-label ml-2" for="block-noncontacts-637b8c95431d3637b8c952b4ca13-0">
                            ...
                            <div data-preference="entertosend">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="enter-to-send-637b8c95431d3637b8c952b4ca13" >
                                    <label class="custom-control-label" for="enter-to-send-637b8c95431d3637b8c952b4ca13">
                                        Use enter to send
                                    </label>
                                </div>
                            </div>
    ...
    >
        ...
        <div class="menubar d-flex " id="action-menu-3-menubar">
                ...
                <div class="action-menu-trigger">
                    ...
                    <div class="dropdown-divider" role="presentation"><span class="filler">&nbsp;</span></div>
                                                                <a href="https://moodle.nottingham.ac.uk/user/profile.php?id=308477" class="dropdown-item menu-action" role="menuitem" data-title="profile,moodle" tabindex="-1" aria-labelledby="actionmenuaction-8">
                                <i class="icon fa fa-user fa-fw " aria-hidden="true"  ></i>
                    ...
                    <div class="dropdown-divider" role="presentation"><span class="filler">&nbsp;</span></div>
                                                                <a href="https://moodle.nottingham.ac.uk/login/logout.php?sesskey=kaFBEDnIK7" class="dropdown-item menu-action" role="menuitem" data-title="logout,moodle" tabindex="-1" aria-labelledby="actionmenuaction-12">
                                <i class="icon fa fa-sign-out fa-fw " aria-hidden="true"  ></i>
        ...
        <nav class="list-group" aria-label="">
            <ul>
                    ...
                    <li>
                        <a class="list-group-item list-group-item-action  " href="https://moodle.nottingham.ac.uk/course/view.php?id=12001" data-key="12001" data-isexpandable="1" data-indent="1" data-showdivider="0" data-type="20" data-nodetype="1" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="mycourses">
                            <div class="ml-1">
                                <div class="media">
                                        <span class="media-left">
                                            <i class="icon fa fa-graduation-cap fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                    <span class="media-body ">Presessional Programmes - EAP Toolkit (Education) (UK)</span>
                                </div>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a class="list-group-item list-group-item-action  " href="https://moodle.nottingham.ac.uk/course/view.php?id=20538" data-key="20538" data-isexpandable="1" data-indent="1" data-showdivider="0" data-type="20" data-nodetype="1" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="mycourses">
                            <div class="ml-1">
                                <div class="media">
                                        <span class="media-left">
                                            <i class="icon fa fa-graduation-cap fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                    <span class="media-body ">Presessional Programmes (Education) (UK)</span>
                                </div>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a class="list-group-item list-group-item-action  " href="https://moodle.nottingham.ac.uk/course/view.php?id=123305" data-key="123305" data-isexpandable="1" data-indent="1" data-showdivider="0" data-type="20" data-nodetype="1" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="mycourses">
                            <div class="ml-1">
                                <div class="media">
                                        <span class="media-left">
                                            <i class="icon fa fa-graduation-cap fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                    <span class="media-body ">Presessional English for Academic Purposes Level 3 (CELEN003 UNUK) (C022 21-22)</span>
                                </div>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a class="list-group-item list-group-item-action  " href="https://moodle.nottingham.ac.uk/course/view.php?id=123310" data-key="123310" data-isexpandable="1" data-indent="1" data-showdivider="0" data-type="20" data-nodetype="1" data-collapse="0" data-forceopen="0" data-isactive="0" data-hidden="0" data-preceedwithhr="0" data-parent-key="mycourses">
                            <div class="ml-1">
                                <div class="media">
                                        <span class="media-left">
                                            <i class="icon fa fa-graduation-cap fa-fw " aria-hidden="true"  ></i>
                                        </span>
                                    <span class="media-body ">Presessional English for Academic Purposes Level 4 (CELEN004 UNUK) (C033 21-22)</span>
                                </div>
                            </div>
                        </a>
                    </li>
    ...
    <a class="dropdown-toggle nav-link" id="drop-down-637b8c954e778637b8c952b4ca22" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"  aria-controls="drop-down-menu-637b8c954e778637b8c952b4ca22">
        Library Search (NUSearch)
    </a>
    <div class="dropdown-menu" role="menu" id="drop-down-menu-637b8c954e778637b8c952b4ca22" aria-labelledby="drop-down-637b8c954e778637b8c952b4ca22">
    ...
    <a class="dropdown-toggle nav-link" id="drop-down-637b8c954e80c637b8c952b4ca23" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"  aria-controls="drop-down-menu-637b8c954e80c637b8c952b4ca23">
        Library Locations
    </a>
    <div class="dropdown-menu" role="menu" id="drop-down-menu-637b8c954e80c637b8c952b4ca23" aria-labelledby="drop-down-637b8c954e80c637b8c952b4ca23">
    ...
    <a class="dropdown-toggle nav-link" id="drop-down-637b8c954e8f6637b8c952b4ca24" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"  aria-controls="drop-down-menu-637b8c954e8f6637b8c952b4ca24">
        Studying Effectively
    </a>
    <div class="dropdown-menu" role="menu" id="drop-down-menu-637b8c954e8f6637b8c952b4ca24" aria-labelledby="drop-down-637b8c954e8f6637b8c952b4ca24">
    ...
    <a class="dropdown-toggle nav-link" id="drop-down-637b8c954e9ca637b8c952b4ca25" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"  aria-controls="drop-down-menu-637b8c954e9ca637b8c952b4ca25">
        Help
    </a>
    <div class="dropdown-menu" role="menu" id="drop-down-menu-637b8c954e9ca637b8c952b4ca25" aria-labelledby="drop-down-637b8c954e9ca637b8c952b4ca25">
...
function(
    ...
    var toggle = $('#message-drawer-toggle-637b8c953d13f637b8c952b4ca3');
    Popover.init(toggle);
});
;
        ...
        require(['jquery', 'core/custom_interaction_events'], function($, CustomEvents) {
            ...
            $('#jump-to-activity').on(CustomEvents.events.accessibleChange, function() {
                ...
                $('#url_select_f637b8c952b4ca12').submit();
            });
        });
    ;

require(['jquery', 'core_message/message_drawer'], function($, MessageDrawer) {
    var root = $('#message-drawer-637b8c95431d3637b8c952b4ca13');
    MessageDrawer.init(root, '637b8c95431d3637b8c952b4ca13', false);
});
;
...
;
M.util.js_pending('local_fullscreen/button'); require(['local_fullscreen/button'], function(amd) {amd.init("1", "Ctrl + Alt + b"); M.util.js_complete('local_fullscreen/button');});;
...
M.util.help_popups.setup(Y);
 M.util.js_pending('random637b8c952b4ca26'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random637b8c952b4ca26'); });
})();
//]]>
</script>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"85d36fdef0","applicationID":"3213358","transactionName":"NlJTbBQEWksEAEFYXw8YZEoPSllXAUxHVEMOQkNbA0pCUQAUG0FYEQ==","queueTime":0,"applicationTime":625,"atts":"GhVEGlweSRRHAhcLSxxK","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>